...
/* 템플릿 리터럴 */
/* ES6부터 도입된 백틱을 사용한 표현식으로 멀티라인 문자열, 표현식 삽입 등
   편리한 문자열 처리 기능을 제공하는 문자열 표기법이다.  
*/

//일반 문자열 내에서는 줄바꿈이 허용되지 않는다. --오류
//var str = '안녕하세요, 
//판다입니다:)';

//줄바꿈 하려면 이스케이프 시퀀스를 사용해야 한다.
var str = '안녕하세요, \n판다입니다. :)'
console.log(str);
