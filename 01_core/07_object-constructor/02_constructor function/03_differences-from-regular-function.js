...
// 첫 문자를 대문자로 기술하여 구별 할 수 있도록 노력한다.
...
console.log(teacher);        // 일반 함수로서 호출된 Teacher 는 반환문이 없으므로 undefined으로 반환 
...
// 문자열, 숫자, 논리(true or fales)를 반환한다. -> 데이터 타입 변환에 사용 
