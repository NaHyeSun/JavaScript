...
//argument 객체의 프로퍼티로 보관은 되나, 첫번째 판다만 출력되게 된다. 
result = hello('판다', '다람쥐', '원숭이');
console.log(result); 

//인수를 전달하지 않을 경우는 undefined로 나옴 
result = hello();
console.log(result);
...
//result = hi('');                             //빈 문자열 오류 
//result = hi('다람쥐', '원숭이', '판다');      // arguments = 1이 아니므로 오류 
//result = hi(1);                             //문자열이 아니므로 오류 